...
reader = csv.reader(file('ex14_compare_solutions_2_out.csv'))
...
ax1.set_ylabel('$\log(L2-\mathrm{error})$')
...
fit_msg = 'Slope $\sim$ ' + '%.2f' % fit[0]
ax1.text(0.95, 0.95, fit_msg, verticalalignment='top', horizontalalignment='right', transform=ax1.transAxes)
plt.grid(True)
